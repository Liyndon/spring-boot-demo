...
public interface LoggingEventDao{
	 ...
	 * @return
	 */
    int updateLoggingEvent(@Param("enti") LoggingEvent value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLoggingEvent(@Param("enti") LoggingEvent value, @Param("assist") Assist assist);
}
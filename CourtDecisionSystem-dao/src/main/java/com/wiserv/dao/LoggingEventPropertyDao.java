...
public interface LoggingEventPropertyDao{
	/**
	 ...
	 * @return
	 */
    int updateLoggingEventProperty(@Param("enti") LoggingEventProperty value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLoggingEventProperty(@Param("enti") LoggingEventProperty value, @Param("assist") Assist assist);
}
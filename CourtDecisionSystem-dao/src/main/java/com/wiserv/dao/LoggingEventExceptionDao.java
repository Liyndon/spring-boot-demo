...
public interface LoggingEventExceptionDao{
	 ...
	 * @return
	 */
    int updateLoggingEventException(@Param("enti") LoggingEventException value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLoggingEventException(@Param("enti") LoggingEventException value, @Param("assist") Assist assist);
}